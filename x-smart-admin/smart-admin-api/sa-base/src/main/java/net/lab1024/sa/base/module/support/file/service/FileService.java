...
public class FileService {
    ...
    public ResponseDTO<String> getFileUrlById(Long fileId) {
        if (fileId == null) {
            return ResponseDTO.error(UserErrorCode.PARAM_ERROR);
        }
        ...
        ResponseDTO<String> fileUrlResponse = fileStorageService.getFileUrl(file.getFileKey());
        if (!fileUrlResponse.getOk()) {
            return fileUrlResponse;
        }
        return ResponseDTO.ok(fileUrlResponse.getData());
    }
