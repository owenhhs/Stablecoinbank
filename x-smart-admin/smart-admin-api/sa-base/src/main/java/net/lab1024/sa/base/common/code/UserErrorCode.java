...
public enum UserErrorCode implements ErrorCode {
    ...
    INPUT_CONTENT_ILLEGAL(30013, "输入内容不合法"),

    COMMAND_RUNNING_ERROR(30014, "命令运行失败"),
    LOG_FILE_NOT_EXIST(30015, "日志文件不存在"),

    OTP_DISABLE(30100, "多因子未启用"),
    OTP_BOUND(30101, "多因子已绑定"),
    OTP_UNBOUND(30102, "多因子未绑定"),
    OTP_CODE_FAIL(30103, "验证码错误"),
    OTP_NEED_VERIFY(30104, "需要校验多因子"),
    OTP_SCRIP_EXPIRED(30105, "临时凭证不存在或已过期"),
    OTP_ERROR_FREQUENTLY(30106, "验证码输入错误过于频繁，请等30秒再试"),

    ORDER_STATUS_NON_OPERATIONAL(30200, "订单不可操作"),
    ORDER_STATUS_REFUND_REASON(30201, "请输入退款原因"),

    ORDER_SETTLE_CONFIRM_ERROR(30202, "确认收款失败"),
    ;
