...
public class SmartLocalDateUtil {
    ...
    public static String getCurrentTimeStr(SmartDateFormatterEnum formatterEnum) {
        return format(LocalDateTime.now(), formatterEnum);
    }
     ...
     * @return
     */
    public static LocalDateTime getPreviousStart(){
        LocalDateTime startOfDay = LocalDateTime.of(LocalDate.now(), LocalTime.MIN);
        return startOfDay.minusDays(1);
    }


    public static LocalDateTime getNowStart(String date){
        LocalDate localDate = SmartLocalDateUtil.parseDate(date, SmartDateFormatterEnum.YMD);
        return LocalDateTime.of(localDate, LocalTime.MIN);
    }

    public static LocalDateTime getNowEnd(String date){
        LocalDate localDate = SmartLocalDateUtil.parseDate(date, SmartDateFormatterEnum.YMD);
     ...
     * @return
     */
    public static LocalDateTime getPreviousEnd(){
    ...
    public static Long dateToTimestamp(String date) {
        return dateToTimestamp(date, SmartDateFormatterEnum.YMD_HMS);
    }
    ...
    public static Long dateToTimestamp(String date, SmartDateFormatterEnum formatterEnum) {
        LocalDateTime dateTime = LocalDateTime.parse(date, formatterEnum.getFormatter());
    ...
    public static void main(String[] args) {
        ...
        LocalDateTime previousDay1 = endOfDay.minusDays(1);
        System.out.println(previousDay);
        System.out.println(previousDay1);


        LocalDate localDate = SmartLocalDateUtil.parseDate("2024-09-25", SmartDateFormatterEnum.YMD);
