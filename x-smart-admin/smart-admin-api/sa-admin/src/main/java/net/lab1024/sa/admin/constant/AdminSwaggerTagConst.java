...
public class AdminSwaggerTagConst extends SwaggerTagConst {
    ...
    public static class Business {
        ...
        public static final String MERCHANT_MANAGE_PAYMENT_METHOD = "商户管理-付款方式管理";

        public static final String MERCHANT_MANAGE_USER = "商户管理-用户管理";

        public static final String ORDER_MANAGE_PAYMENT = "订单管理-支付订单";
