...
public class DepartmentCacheManager {
    ...
    @CacheEvict(value = {AdminCacheConst.Department.DEPARTMENT_CACHE, AdminCacheConst.Department.DEPARTMENT_LIST_CACHE, AdminCacheConst.Department.DEPARTMENT_MAP_CACHE, AdminCacheConst.Department.DEPARTMENT_SELF_CHILDREN_CACHE, AdminCacheConst.Department.DEPARTMENT_TREE_CACHE, AdminCacheConst.Department.DEPARTMENT_PATH_CACHE,}, allEntries = true)
     ...
     * @return
     */
    @Cacheable(AdminCacheConst.Department.DEPARTMENT_CACHE)
    public DepartmentEntity getDepartmentById(Long departmentId) {
        return departmentDao.selectById(departmentId);
    }


    public List<DepartmentEntity> getDepartmentListByIds(List<Long> departmentIds) {
        return departmentDao.selectBatchIds(departmentIds);
    }
