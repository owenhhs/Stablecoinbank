...
public class RoleService {
    ...
    public ResponseDTO<List<RoleVO>> getAllRole() {
        RequestEmployee requestUser = (RequestEmployee) SmartRequestUtil.getRequestUser();
        LambdaQueryWrapper<RoleEntity> queryWrapper = new LambdaQueryWrapper<>();
        if (requestUser.getAdministratorFlag().equals(false)) {
            queryWrapper.ne(RoleEntity::getRoleCode, "super_admin");
        }
