...
public class EmployeeController {
    ...
    @Operation(summary = "重置员工多因子")
    @GetMapping("/employee/update/otp/reset/{employeeId}")
    @SaCheckPermission("system:employee:otp:reset")
    public ResponseDTO<String> resetEmployeeOtp(@PathVariable Long employeeId) {
        employeeService.resetEmployeeOtp(employeeId);
