...
public interface EmployeeDao extends BaseMapper<EmployeeEntity> {
     ...
     * 查询员工列表
     */
    @DataScope(dataScopeType = DataScopeTypeEnum.NOTICE, joinSql = "t_employee.employee_id in (#employeeIds)")
     ...
     * 通过登录名查询
     */
    @DataScope(dataScopeType = DataScopeTypeEnum.NOTICE, joinSql = "employee_id in (#employeeIds)")
