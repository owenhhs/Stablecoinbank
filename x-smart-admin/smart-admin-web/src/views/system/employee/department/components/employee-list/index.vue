  ...
  <a-card class="employee-container">
    ...
    >
      <template #bodyCell="{ text, record, index, column }">
        ...
        <template v-if="column.dataIndex === 'enabledOtpFlag'">
        ...
        <template v-else-if="column.dataIndex === 'operate'">
          <div class="smart-table-operate">
            ...
            >
            <a-button
                v-privilege="'system:employee:otp:reset'"
                type="link"
                size="small"
                @click="resetOtp(record.employeeId)"
                >重置多因子</a-button
            >
...
<script setup lang="ts">
  ...
  function showDrawer(rowData) {
    ...
    if (rowData) {
      ...
      params.enabledOtpFlag = params.enabledOtpFlag ? 1 : 0;
