<template>
  <div class="box-item verify-otp">
    ...
    <a-form ref="formRef" class="login-form" :model="verifyForm" :rules="rules">
      <a-form-item name="code">
        <a-input v-model:value.trim="verifyForm.code" placeholder="请输入验证码" />
      </a-form-item>
      <a-form-item>
        <div class="btn" @click="onVerify">校验MFA</div>
      </a-form-item>
    </a-form>
  </div>
</template>
