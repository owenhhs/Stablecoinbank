...
<script setup>
  ...
  import SettlementDetailForm from '/@/views/business/parent-settlement/settlement-detail-form.vue';
  ...
  async function queryData() {
    ...
    try {
      ...
      let queryResult = await settlementInfoApi.queryPageByParentSettleDetail(params);
