...
<template>
  ...
  <a-card size="small" :bordered="false" :hoverable="true">
    ...
    <MerchantManageForm ref="formRef" @reloadList="queryData"/>
...
import MerchantManageForm from './merchant-manage-form.vue';
...
async function queryData() {
  ...
  try {
    let queryResult = await merchantManageApi.queryPage(queryForm);
...
async function requestDelete(data) {
  ...
  try {
    ...
    await merchantManageApi.delete(data.id);
...
async function requestBatchDelete() {
  try {
    SmartLoading.show();
    await merchantManageApi.batchDelete(selectedRowKeyList.value);
    message.success('删除成功');
    queryData();
  } catch (e) {
    smartSentry.captureError(e);
