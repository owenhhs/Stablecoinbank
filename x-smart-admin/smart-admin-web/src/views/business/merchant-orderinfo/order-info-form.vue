  ...
  <a-drawer :title="$t('business.form.detail')" width="600" :open="visibleFlag" @close="onClose" :maskClosable="false" :destroyOnClose="true">
    <a-form ref="formRef" :model="form" :rules="rules" layout="vertical">
      ...
      <a-form-item v-if="form.depositType === 'qrcode'" :label="$t('order.form.paymentChannel')" name="paymentChannel">
        <a-input disabled style="width: 100%" v-model:value="form.paymentChannel" :placeholder="$t('order.form.paymentChannel')" />
      </a-form-item>
      ...
      <a-form-item :label="$t('order.form.refundReason')" name="refundReason">
        <a-input disabled style="width: 100%" v-model:value="form.refundReason" :placeholder="$t('order.form.refundReason')" />
      </a-form-item>
    </a-form>
