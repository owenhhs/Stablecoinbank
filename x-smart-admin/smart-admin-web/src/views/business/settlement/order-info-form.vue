  ...
  <a-drawer title="详情" width="600" :open="visibleFlag" @close="onClose" :maskClosable="false" :destroyOnClose="true">
    <a-form ref="formRef" :model="form" :rules="rules" layout="vertical">
      ...
      <a-form-item label="二维码渠道，deposit_type=qrcode时有值" name="paymentChannel">
        <a-input disabled style="width: 100%" v-model:value="form.paymentChannel" placeholder="二维码渠道，deposit_type=qrcode时有值" />
      </a-form-item>
      ...
      <a-form-item label="回单地址,存款成功后银行回单地址,图片url" name="depositFileId">
        <a-input disabled style="width: 100%" v-model:value="form.depositFileId" placeholder="回单地址,存款成功后银行回单地址,图片url" />
      </a-form-item>
