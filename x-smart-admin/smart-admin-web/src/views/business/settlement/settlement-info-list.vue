...
async function exportOrders() {
  try {
    SmartLoading.show();
    await settlementInfoApi.exportOrders(queryForm);
  } catch (e) {
    smartSentry.captureError(e);
  } finally {
    SmartLoading.hide();
