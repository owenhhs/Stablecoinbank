...
export const useUserStore = defineStore({
  ...
  actions: {
    ...
    setUserLoginInfo(data) {
      ...
      const locale = getInitializedLanguage()

      let menuList = []
      for (const menuKey in data.menuList) {
        let menu = data.menuList[menuKey];
        menuList.push({
          ...menu,
          menuName: ('zh_CN' === locale || menu.menuNameEn === null || menu.menuNameEn === undefined || menu.menuNameEn.length === 0) ?
