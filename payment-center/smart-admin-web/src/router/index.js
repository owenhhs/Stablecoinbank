...
import {PAGE_PATH_404, PAGE_PATH_CASHIER, PAGE_PATH_LOGIN} from '/@/constants/common-const';
...
router.beforeEach(async (to, from, next) => {
  ...
  // 公共页面，任何时候都可以跳转
  if (to.path === PAGE_PATH_404 || to.path === PAGE_PATH_LOGIN || to.path.startsWith(PAGE_PATH_CASHIER)) {
    next();
    return;
  }
