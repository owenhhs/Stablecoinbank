  ...
  <a-drawer title="详情" width="600" :open="visibleFlag" @close="onClose" :maskClosable="false" :destroyOnClose="true">
    <a-form ref="formRef" :model="form" :rules="rules" layout="vertical">
      ...
      <a-form-item label="商户名称" name="merName">
        <a-input-number disabled style="width: 100%" v-model:value="form.merName" placeholder="商户名称" />
      </a-form-item>
      ...
      <a-form-item label="支付方式" name="paymentMethod">
        <SmartEnumSelect disabled style="width: 100%" v-model:value="form.paymentMethod" placeholder="支付方式" enumName="PAYMENT_METHOD" />
      </a-form-item>
      <a-form-item label="收款人" name="accountName">
        <a-input disabled style="width: 100%" v-model:value="form.accountName" placeholder="收款人" />
      </a-form-item>
      ...
      <a-form-item label="订单状态 1 待确认 2 已确认 3 挂起" name="status">
        <SmartEnumSelect
          ...
          placeholder="订单状态 1 待确认 2 已确认 3 挂起"
      ...
      <a-form-item label="付款状态 1 待付款 2 已付款 3 取消" name="status">
        <SmartEnumSelect
          ...
          placeholder="付款状态 1 待付款 2 已付款 3 取消"
          enumName="ORDER_PAY_STATUS"
        />
      </a-form-item>
