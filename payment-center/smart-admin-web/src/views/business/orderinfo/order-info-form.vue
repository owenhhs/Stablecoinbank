...
<template>
  <a-drawer title="详情" width="600" :open="visibleFlag" @close="onClose" :maskClosable="false" :destroyOnClose="true">
    <a-form ref="formRef" :model="form" :rules="rules" layout="vertical">
      ...
      <a-form-item label="子商户名称" name="merName">
        <a-input disabled style="width: 100%" v-model:value="form.subMerName" placeholder="子商户名称" />
      </a-form-item>
      <a-form-item label="付款方式" name="paymentMethod">
        <SmartEnumSelect disabled style="width: 100%" v-model:value="form.paymentMethod" placeholder="付款方式" enumName="PAYMENT_METHOD" />
      </a-form-item>
