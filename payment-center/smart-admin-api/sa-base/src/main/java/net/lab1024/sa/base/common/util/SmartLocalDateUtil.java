...
public class SmartLocalDateUtil {
    ...
    public static LocalDateTime getDateForTimestamp(Long timestamp) {
    ...
    public static String getTodayStart() {
        return SmartLocalDateUtil.format(LocalDateTime.of(LocalDate.now(), LocalTime.MIN), SmartDateFormatterEnum.YMD_HMS);
    }

    public static String getTodayEnd() {
        return SmartLocalDateUtil.format(LocalDateTime.of(LocalDate.now(), LocalTime.MAX), SmartDateFormatterEnum.YMD_HMS);
    }
